...
import { TAMUK_BLUE, TAMUK_GOLD } from '../constants/colors';
    ...
    Alert.alert('Log Out', 'Are you sure you want to log out?', [
      { text: 'Cancel', style: 'cancel' },
      {
        ...
        onPress: () => {
          onClose();
          setTimeout(() => {
            // TODO: clear token e.g. await AsyncStorage.removeItem('token');
        ...
        <SafeAreaView style={styles.drawerInner}>
          ...
          <View style={styles.drawerHeader}>
            ...
            <Text style={styles.drawerUsername}>
              {user?.username ?? 'jdoe_tamuk'}
            </Text>
            <Text style={styles.drawerMajor}>
              {user?.major ?? 'Computer Science'} · {user?.year ?? 'Junior'}
            </Text>
          </View>
